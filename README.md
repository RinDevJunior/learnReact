...
For an example, see [pages/aaa.js](./pages/aaa.js).

## Available Widgets

### [DateTime](./components/widgets/datetime/aaa.js)
...
### [Jenkins](./components/widgets/jenkins/aaa.js)
...
### [SonarQube](./components/widgets/sonarqube/aaa.js)
